...
$ADServer = 'DLX' #change name to your DC
...
New-Item -ItemType Directory -Path "C:\Users\$($ADUser.sAMAccountname)"
#New-Item -ItemType Directory -Path "\\dlx\Users$\$($ADUser.DisplayName)"
...
$userfolder = "C:\Users\$($ADUser.sAMAccountname)"
#$userfolder = "\\DLX\Users$\$($ADUser.DisplayName)"
...
$homeDirectory = "c:\Users\$($ADUser.sAMAccountname)" #This maps the folder for each user 
#$homeDirectory = "\\DLX\Users$\$($ADUser.DisplayName)" #This maps the folder for each user 
